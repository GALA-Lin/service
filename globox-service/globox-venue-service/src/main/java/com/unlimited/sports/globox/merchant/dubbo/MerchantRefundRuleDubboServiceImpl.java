...
import static com.unlimited.sports.globox.common.result.MerchantErrorCode.*;
...
public class MerchantRefundRuleDubboServiceImpl implements MerchantRefundRuleDubboService {
    ...
    public RpcResult<MerchantRefundRuleJudgeResultVo> judgeApplicableRefundRule(MerchantRefundRuleJudgeRequestDto request) {
        ...
        if (refundApplyTime.isAfter(eventStartTime)) {
            ...
            log.warn(reason);
            return RpcResult.error(REFUND_TIME_AFTER_EVENT_START);
        }
        ...
        for (MerchantRefundRuleDetailDto detail : ruleDetails) {
            ...
            if (isInTimeRange) {
                ...
                return RpcResult.ok(
                        MerchantRefundRuleJudgeResultVo.builder()
                                .canRefund(true)
