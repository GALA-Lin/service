...
public class LocalDateUtils {
     ...
     */
    public static LocalDateTime plus(LocalDateTime localDateTime, long num, ChronoUnit chronoUnit) {
        return localDateTime.plus(num, chronoUnit);
    }

    public static LocalDate plus(LocalDate localDate, long num, ChronoUnit chronoUnit) {
     ...
     *
     * @param dateTime1 第一个 LocalDateTime
     * @param dateTime2 第二个 LocalDateTime
     * @return -1 表示 dateTime1 早于 dateTime2, 0 表示相等, 1 表示 dateTime1 晚于 dateTime2
     */
...
//        return Math.abs(start.until(end, chronoUnit));
    ...
    /**
     * yyyy-MM-DDTHH:mm:ss+TIMEZONE 格式转 LocalDateTime
     */
    public static LocalDateTime toLocalDateTime(String s) {
        // 例: 2026-01-08T12:34:56+08:00 或 2026-01-08T04:34:56Z
