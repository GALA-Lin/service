...
public enum PaymentsCode implements ResultCode {
    ...
    PAYMENT_INFO_NOT_EXIST(3002, "支付信息不存在，请稍后再试"),
    PAYMENT_CREATE_FAILED(3003, "支付信息创建失败，请稍后再试"),
    PAYMENT_REFUND_FAILED(3004, "退款失败，请稍后再试"),
    ORDER_PAID(3005, "订单已支付，无需再次申请支付"),
    NOT_SUPPORTED_PAYMENT_TYPE(3006, "不支持的支付方式，请重新选择支付类型"),
