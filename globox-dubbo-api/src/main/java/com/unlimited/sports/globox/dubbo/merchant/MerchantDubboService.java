...
public interface MerchantDubboService {
     ...
     */
    PricingResultDto quoteVenue(PricingRequestDto dto);


    PricingActivityResultDto quoteVenueActivity(PricingActivityRequestDto dto);
     ...
     */
    VenueSnapshotResultDto getVenueSnapshot(VenueSnapshotRequestDto dto);
}
