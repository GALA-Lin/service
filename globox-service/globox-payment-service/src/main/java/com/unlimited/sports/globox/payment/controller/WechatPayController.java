...
public class WechatPayController {
    ...
    @ResponseBody
    public WechatPayNotifyVo notifyCallback(HttpServletRequest request, HttpServletResponse response) {
        log.info("异步回调触发");
        return wechatPayService.handleCallback(request, response);
    }
}
