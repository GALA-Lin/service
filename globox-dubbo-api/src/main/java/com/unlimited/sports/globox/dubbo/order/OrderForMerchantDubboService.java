...
public interface OrderForMerchantDubboService {
     ...
     */
    RpcResult<IPage<MerchantGetOrderResultDto>> merchantGetOrderPage(
     ...
     * @return 订单详情 Dto
     */
    RpcResult<MerchantGetOrderResultDto> merchantGetOrderDetails(
     ...
     */
    RpcResult<MerchantCancelOrderResultDto> merchantCancelUnpaidOrder(
            @Valid @NotNull(message = "请求参数不能为空")
     ...
     */
    RpcResult<MerchantConfirmResultDto> merchantConfirm(MerchantConfirmRequestDto dto);
}
